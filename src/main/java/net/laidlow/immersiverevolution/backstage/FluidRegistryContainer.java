...
public class FluidRegistryContainer {
    ...
    public FluidRegistryContainer(String name, FluidType.Properties typeProperties,
        ...
        this.type = IRFluids.FLUID_TYPES.register(name, () -> new FluidType(this.typeProperties) {
            @Override
        ...
        this.source = IRFluids.FLUIDS.register(name + "_source", () -> new ForgeFlowingFluid.Source(this.properties));
        this.flowing = IRFluids.FLUIDS.register(name + "_flowing",
        ...
        this.block = IRBlocks.BLOCKS.register(name, () -> new LiquidBlock(this.source, blockProperties));
        this.properties.block(this.block);

        this.bucket = IRItems.ITEMS.register(name + "_bucket", () -> new BucketItem(this.source, itemProperties));
